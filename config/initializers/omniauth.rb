...
Rails.application.config.middleware.use OmniAuth::Builder do
  provider :facebook, ENV['FB_AUTH_CLIENT_ID'], ENV['FB_AUTH_CLIENT_SECRET'], scope: 'email, user_about_me, publish_actions, user_birthday, user_hometown, user_friends, read_friendlists, friends_location, publish_actions'
end
